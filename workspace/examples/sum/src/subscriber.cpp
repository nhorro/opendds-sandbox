...
using SumRequestTypeSupport_var = SumRequestTypeSupport::_var_type;
using SumResponseTypeSupport_var = SumResponseTypeSupport::_var_type;
using SumRequestDataWriter_var = SumRequestDataWriter::_var_type;
using SumResponseDataReader_var = SumResponseDataReader::_var_type;
